...
])('should handle doing a deep equals correctly for the primitives: %s | %s', (a, b, result) => {
...
it.each([
  ...
  [[[[[[]]]]], [[[[[]]]]], true],
  [[[[[[]]]]], [[[[[1]]]]], false],
])('should handle doing a deep equals correctly for the arrays: %s | %s', (a, b, result) => {
  expect(deepEquals(a, b)).toBe(result);
});
