...
import type { Configs, Data, DataCollection, Graph, Subscribers, Store } from './index.type';
...
/* Re-export types */
export type { Configs, Data, DataCollection, Graph, Store, Updater } from './index.type';
